...
namespace WorldOfBugs.LookingAround {
    ...
    public class HeuristicRandom : HeuristicComponent {
        ...
        public float DoNothingProb {
            get {
                return _DoNothingProb - (HorizontalDoNothingProb * VerticalDoNothingProb);
            }
        }
        ...
        protected Vector3 RandomPoint() {
            float rad = UnityEngine.Random.Range(LookAroundAgent.HMIN,
                                                 LookAroundAgent.HMAX) * Mathf.Deg2Rad;
