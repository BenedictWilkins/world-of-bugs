...
namespace WorldOfBugs {
    ...
    public class ActionAttribute : System.Attribute {
        ...
        public static string[] ActionMeanings(Unity.MLAgents.Agent agent) {
            ...
            IEnumerable<string> continuous_info = GetMethodInfo<Action<float>>(agent).Select(x => x.Name);
        ...
        static MethodInfo[] GetMethodInfo<D>(Unity.MLAgents.Agent agent) where D : System.Delegate {
        ...
        static bool IsMethodCompatibleWithDelegate<T>(MethodInfo method) where T : System.Delegate  {
