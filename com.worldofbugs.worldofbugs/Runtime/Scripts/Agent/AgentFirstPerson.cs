...
namespace WorldOfBugs {
    ...
    public abstract class AgentFirstPerson : Agent {
        ...
        [SerializeField, NotNull,
         Tooltip("Camera that is used to create the bug mask, this camera should use the ShowBug shader and a RenderTexture.")]
        private Camera _cameraBugMask; // camera used to show bugs

        public Camera CameraBugMask {
            get {
                return _cameraBugMask;
            }
        }
