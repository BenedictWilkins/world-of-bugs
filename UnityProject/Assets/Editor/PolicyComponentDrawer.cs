...
[CustomPropertyDrawer(typeof(PolicyComponent))]
public class PolicyComponentDrawer : PropertyDrawer {
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
        ...
        PolicyComponent[] choices = go.GetComponents<PolicyComponent>();
        ...
        if(EditorGUI.EndChangeCheck()) {
            foreach (PolicyComponent h in choices) {
                h.enabled = false;
            }
