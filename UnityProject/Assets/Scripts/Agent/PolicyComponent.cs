...
namespace WorldOfBugs { 
    ...
    public abstract class PolicyComponent : MonoBehaviour, IHeuristicProvider  {
        
        public abstract bool isHeuristic { get; }
        public abstract void Heuristic(in ActionBuffers buffer);
       
        public void OnEnable() {
            Debug.Log("ENABLE!");
            // The behaviour type should always be default. The Heuristic method is called by the actuator, this is to allow the python process to continue.
